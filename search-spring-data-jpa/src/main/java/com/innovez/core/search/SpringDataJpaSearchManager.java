...
import com.innovez.core.search.model.SearchableMetamodelReader;
...
public class SpringDataJpaSearchManager implements SearchManager {
	...
	@Autowired
	private List<SearchableMetamodelReader> metamodelReaders;
	...
	public SearchableMetamodel getSearchMetamodel(Class<?> target) {
		...
		SearchableMetamodelReader searchMetamodelReader = getSearchMetamodelReader(target);
	...
	private SearchableMetamodelReader getSearchMetamodelReader(Class<?> target) {
		logger.debug("Retrieve search-metamodel-reader for target type : " + target.getName());
		SearchableMetamodelReader searchMetamodelReader = null;
		for(SearchableMetamodelReader metamodelReader : metamodelReaders) {

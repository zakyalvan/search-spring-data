...
public class SimpleSearchFormRendererTag extends SimpleTagSupport {
	private static final Logger LOGGER = LoggerFactory.getLogger(SimpleSearchFormRendererTag.class);
	...
	public void doTag() throws JspException, IOException {
		 ...
		 */
		String searchButtonCssClass = "btn btn-default btn-sm";
		...
		if(formObject.isEnabled()) {
			searchButtonCssClass = "btn btn-primary btn-sm";
		...
		String keywordPlaceholder = 
				applicationContext.getMessage(
						...
						placeholderText, 
						LocaleContextHolder.getLocale());
		htmlFormBuilder.append("<input type='text' value='" + parameterValue + "' name='_simpleSearchForm_searchParameter' class='form-control input-sm search-keyword' placeholder='" + keywordPlaceholder + "' " + searchFieldAutofocus + " />");
		...
		scriptFormBuilder.append("$(\".search-keyword\").focus();");
		scriptFormBuilder.append("});");
		
		//end tag of main document function
		scriptFormBuilder.append("});");
		//end tag of script
